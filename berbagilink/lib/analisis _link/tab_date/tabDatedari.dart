...
class Datedari extends StatefulWidget {
  const Datedari({super.key});

  @override
  State<Datedari> createState() => _artikelbaruState();
}

// ignore: camel_case_types
class _artikelbaruState extends State<Datedari> {
  File? image;
