...
import 'package:berbagilink/ubahTampilan/tautan/daftarLink/tab_daftarlink/whatsapp/whatsapp.dart';
...
class WhatsAppmain extends StatefulWidget {
  ...
  @override
  State<WhatsAppmain> createState() => _DaftarLink();
}
...
// ignore: camel_case_types
class _DaftarLink extends State<WhatsAppmain>
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: const BoxDecoration(
        ...
        color: Color.fromARGB(225,37, 185, 132),
      ),
